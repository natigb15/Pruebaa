...
$sqlPedidosHoy = "SELECT COUNT(*) as total FROM PEDIDO WHERE ID_ESTADO = 'E04' AND FECHA_PEDIDO = CURDATE()";
    ...
    <main class="main-content">
        ...
        <div id="dashboard-view" class="view-content active">
            <div class="info-card">
                ...
                <p>Hoy es <?php echo strftime('%A, %d de %B %Y'); ?>. Tienes <?php echo $pedidosPendientes; ?> pedidos pendientes de procesar.</p>
            </div>
